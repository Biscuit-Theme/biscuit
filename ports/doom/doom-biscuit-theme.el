;;; doom-biscuit-theme.el --- inspired by the Dark-decay theme -*- lexical-binding: t; no-byte-compile: t; -*-
;; Author: Alxhr0
...
(defgroup doom-biscuit-theme nil
  "Options for the `doom-biscuit' theme."
  :group 'doom-themes)

(defcustom doom-biscuit-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-biscuit-theme
  :type 'boolean)

(defcustom doom-biscuit-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-biscuit-theme
  :type 'boolean)

(defcustom doom-biscuit-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'doom-biscuit-theme
  :type 'boolean)

(defcustom doom-biscuit-comment-bg doom-biscuit-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-biscuit-theme
  :type 'boolean)

(defcustom doom-biscuit-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-biscuit
  ...
  ((bg         '("#1a1515" "#262626" "black"        ))
   ...
   (violet     '("#77719e" "#8680b3" "brightmagenta"))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-biscuit-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-biscuit-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      blue)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 blue)
   (level2 red)
   (level3 (if doom-biscuit-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if doom-biscuit-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if doom-biscuit-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if doom-biscuit-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if doom-biscuit-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if doom-biscuit-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if doom-biscuit-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright doom-biscuit-brighter-modeline)
   (-modeline-pad
    (when doom-biscuit-padded-modeline
      (if (integerp doom-biscuit-padded-modeline) doom-biscuit-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-biscuit-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
...
;;; doom-biscuit-theme.el ends here
