...
(eval-and-compile
  (defvar biscuit-colors-alist
    '(("biscuit-fg"                . "#DCC9BC")
      ...
      ("biscuit-bright-black"      . "#2d2424")
      ("biscuit-bright-red"        . "#Cf223E")
      ("biscuit-bright-green"      . "#F07342")
      ("biscuit-bright-yellow"     . "#E39C45")
      ("biscuit-bright-blue"       . "#756D94")
      ("biscuit-bright-magenta"    . "#AE3F82")
      ("biscuit-bright-cyan"       . "#768F80")
      ("biscuit-bright-white"      . "#DCC9BC")
      ("biscuit-comment"           . "#453636")
      ("biscuit-highlight"         . "#2d2424")
      ("biscuit-warning"           . "#E39C45")
      ("biscuit-error"             . "#CF223E"))))
